...
namespace ChallengeUbistart.Api.V1.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public AuthController(INotify notify, SignInManager<IdentityUser> signInManager, 
            UserManager<IdentityUser> userManager, IUser user, ILogger<AuthController> logger,
            IOptions<AppSettings> appSettings) : base(notify, user)
        {
